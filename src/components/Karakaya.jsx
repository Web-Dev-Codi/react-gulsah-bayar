        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center pb-12">
            <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
              <div className="py-2">
                <h1 className="text-2xl lg:text-6xl md:leading-snug tracking-tighter f-f-l">Lorem ipsum dolor sit amet consectetur.</h1>
                ...
                <button className="flex items-center cursor-pointer pb-4 md:pb-0 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none">
                  <span aria-label="lets get started" role="button" className="focus outline-none f-f-r text-lg lg:text-2xl font-semibold underline ">Click here</span>
                  <div className="pl-2">
          ...
          <div className="flex flex-wrap flex-row-reverse items-center">
            <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
              <div className="py-2 text-color">
                <div><h1 className="text-2xl dark:text-white lg:text-6xl tracking-tighter md:leading-snug f-f-l font-black">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, ducimus!</h1></div>
